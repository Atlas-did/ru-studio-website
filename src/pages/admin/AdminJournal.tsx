      ...
      {editing && (
        <div className="mb-8 p-6 bg-[rgba(168,164,154,0.04)] border border-[rgba(168,164,154,0.15)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              <label className="block font-sans text-[10px] tracking-[0.1em] text-fg-secondary uppercase mb-1">日期</label>
            ...
            <div className="md:col-span-2">
              <label className="block font-sans text-[10px] tracking-[0.1em] text-fg-secondary uppercase mb-1">摘要</label>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[rgba(168,164,154,0.12)]">
              <th className="text-left py-3 font-sans text-[10px] tracking-[0.1em] text-fg-secondary uppercase">日期</th>
              ...
              <th className="text-left py-3 font-sans text-[10px] tracking-[0.1em] text-fg-secondary uppercase">摘要</th>
          ...
          <tbody>
            {posts.map((p) => (
              <tr key={p.slug} className="border-b border-[rgba(168,164,154,0.06)] hover:bg-[rgba(168,164,154,0.03)]">
                <td className="py-3 font-mono text-xs text-fg-secondary/60">{p.date}</td>
                <td className="py-3">
                ...
                <td className="py-3 font-serif text-xs text-fg-secondary/70 max-w-xs truncate">{p.excerpt}</td>
