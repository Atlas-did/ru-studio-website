    ...
    <div className="bg-ink min-h-screen pt-20 md:pt-28">
      ...
      <div ref={titleRef} className="px-6 md:px-12 py-16 md:py-24">
        <div className="max-w-[1440px] mx-auto">
          ...
          <p className="mt-6 font-serif text-[15px] text-fg-secondary leading-[1.8] max-w-xl">
        ...
        <div className="max-w-[720px] mx-auto">
          {submitted ? (
            <div className="text-center py-16">
              ...
              <p className="font-serif text-sm text-fg-secondary">
                我们会尽快与您取得联系。
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full bg-transparent border-b border-[rgba(168,164,154,0.3)] py-3 font-serif text-mist placeholder:text-fg-secondary/40 focus:outline-none focus:border-mist transition-colors duration-300"
                    placeholder="您的姓名"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  name="message"
                  rows={4}
                  className="w-full bg-transparent border-b border-[rgba(168,164,154,0.3)] py-3 font-serif text-mist placeholder:text-fg-secondary/40 focus:outline-none focus:border-mist transition-colors duration-300 resize-none"
          ...
          <div className="mt-16 pt-8 border-t border-[rgba(168,164,154,0.18)]">
            <p className="font-sans text-[11px] tracking-[0.1em] text-fg-secondary">
