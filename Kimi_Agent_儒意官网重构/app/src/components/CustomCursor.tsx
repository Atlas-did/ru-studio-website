...
export function CustomCursor() {
  ...
  return (
    <>
      ...
      >
        {cursorState === 'view' && (
          <span className="absolute inset-0 flex items-center justify-center text-caption-s text-mist/70 font-sans">
            查看
          </span>
        )}
        {cursorState === 'drag' && (
          <span className="absolute inset-0 flex items-center justify-center text-caption-s text-gold/70 font-sans">
            拖拽
          </span>
        )}
      </div>
